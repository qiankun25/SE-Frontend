        ...
        <div class="condition-tags">
          ...
          >
            ...
            <div class="condition-content">
              <!-- 前提条件 -->
              <div v-if="condition.vehicleClass || condition.excludeNonAnnouncement !== undefined" class="preset-conditions">
                <el-tag type="info" size="small" class="condition-tag">
                  车辆类别: {{ condition.vehicleClass }}
                </el-tag>
                <el-tag 
                  v-if="condition.excludeNonAnnouncement !== undefined" 
                  type="info" 
                  size="small" 
                  class="condition-tag"
                >
              ...
              <div class="main-conditions">
                ...
                <div v-if="condition.companies && condition.companies.length > 0" class="condition-item">
                  ...
                  <el-tag
                    v-for="company in condition.companies.slice(0, 3)"
                    :key="company.id"
                    size="small"
                    class="condition-tag"
                  >
                ...
                <div v-if="condition.vehicleModels && condition.vehicleModels.length > 0" class="condition-item">
                  ...
                  <el-tag
                    v-for="model in condition.vehicleModels.slice(0, 3)"
                    :key="model"
                    size="small"
                    class="condition-tag"
                  >
                ...
                <div v-if="condition.vehicleBrands && condition.vehicleBrands.length > 0" class="condition-item">
                  ...
                  <el-tag
                    v-for="brand in condition.vehicleBrands.slice(0, 3)"
                    :key="brand"
                    size="small"
                    class="condition-tag"
                  >
                ...
                <div v-if="condition.vehicleNames && condition.vehicleNames.length > 0" class="condition-item">
                  ...
                  <el-tag
                    v-for="name in condition.vehicleNames.slice(0, 3)"
                    :key="name"
                    size="small"
                    class="condition-tag"
                  >
                ...
                <!-- 生产地址 -->
                <div v-if="condition.productionAddresses && condition.productionAddresses.length > 0" class="condition-item">
                  <span class="condition-label">生产地址:</span>
                  <el-tag
                    v-for="address in condition.productionAddresses.slice(0, 2)"
                    :key="address"
                    size="small"
                    class="condition-tag"
                  >
                  ...
                  <el-tag v-if="condition.productionAddresses.length > 2" type="info" size="small" class="condition-tag">
                    +{{ condition.productionAddresses.length - 2 }}个
                  </el-tag>
                </div>

                <!-- 生产省份 -->
                <div v-if="condition.productionProvinces && condition.productionProvinces.length > 0" class="condition-item">
                  <span class="condition-label">生产省份:</span>
                  <el-tag
                    v-for="province in condition.productionProvinces.slice(0, 3)"
                    :key="province"
                    size="small"
                    class="condition-tag"
                  >
                  ...
                  <el-tag v-if="condition.productionProvinces.length > 3" type="info" size="small" class="condition-tag">
                ...
                <div v-if="condition.productionCities && condition.productionCities.length > 0" class="condition-item">
                  ...
                  <el-tag
                    v-for="city in condition.productionCities.slice(0, 3)"
                    :key="city"
                    size="small"
                    class="condition-tag"
                  >
                ...
                <div v-if="condition.sixCategories && condition.sixCategories.length > 0" class="condition-item">
                  ...
                  <el-tag
                    v-for="category in condition.sixCategories"
                    :key="category"
                    size="small"
                    class="condition-tag"
                  >
                ...
                <div v-if="condition.fuelTypes && condition.fuelTypes.length > 0" class="condition-item">
                  ...
                  <el-tag
                    v-for="fuel in condition.fuelTypes"
                    :key="fuel"
                    size="small"
                    class="condition-tag"
                  >
                ...
                <!-- 新能源类别 -->
                <div v-if="condition.newEnergyCategories && condition.newEnergyCategories.length > 0" class="condition-item">
                  <span class="condition-label">新能源类别:</span>
                  <el-tag
                    v-for="category in condition.newEnergyCategories"
                    :key="category"
                    size="small"
                    class="condition-tag"
                  >
