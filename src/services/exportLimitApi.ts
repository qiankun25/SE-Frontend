...
export const exportLimitApi = {
  ...
  // 设置角色导出限制（管理员权限）
  async setRoleExportLimit(
    config: RoleExportLimitConfig
  ...
  // 设置用户导出限制（管理员权限）
  async setUserExportLimit(
    config: UserExportLimitConfig
  ): Promise<ApiResponse<any>> {
  ...
  > {
    ...
    return request(`/export-management/config/list?${queryParams.toString()}`);
  },
  ...
  async updateConfig(
    ...
    return request(`/export-management/config/${configId}`, {
      method: "PUT",
  ...
  // 切换配置状态（管理员权限）
  async toggleConfig(configId: number): Promise<ApiResponse<any>> {
    return request(`/export-management/config/${configId}/toggle`, {
      method: "PUT",
    });
  },
  ...
  > {
    ...
    return request(
      `/export-management/usage/statistics?${queryParams.toString()}`
    );
  },
