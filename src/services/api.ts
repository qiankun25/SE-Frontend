...
export const certificateQuantityApi = {
  // 查询合格证总量统计
  async search(params: CertificateQuantityParams): Promise<ApiResponse<{
  ...
  // 导出合格证总量数据
  async export(params: CertificateQuantityParams & ExportParams): Promise<Blob> {
  ...
  // 获取统计概览
  async getStats(params: Partial<CertificateQuantityParams>): Promise<ApiResponse<{
...
export const certificateDetailApi = {
  // 查询合格证详细信息
  async search(params: CertificateDetailParams): Promise<ApiResponse<{
  ...
  // 批量查询合格证信息
  async batchSearch(queries: string[]): Promise<ApiResponse<{
    list: CertificateDetailItem[]
    total: number
    validCount: number
    invalidCount: number
...
export const productAccessApi = {
  // 查询产品准入信息
  async search(params: ProductAccessParams): Promise<ApiResponse<{
...
export const enterpriseAccessApi = {
  // 查询企业准入信息
  async search(params: EnterpriseAccessParams): Promise<ApiResponse<{
  ...
  // 快捷查询
  async quickSearch(type: string): Promise<ApiResponse<{
    list: EnterpriseAccessItem[]
    total: number
  }>> {
...
export const taxDeclarationApi = {
  // 查询财税申报信息
  async search(params: TaxDeclarationParams): Promise<ApiResponse<{
...
export const otherStatisticsApi = {
  // 查询其他统计信息
  async search(params: OtherStatisticsParams): Promise<ApiResponse<{
  ...
  // 获取统计卡片数据
  async getStatsCards(): Promise<ApiResponse<Array<{
    type: string
    label: string
    value: number
    unit: string
...
export const commonApi = {
  // 搜索企业
  async searchCompanies(query: string): Promise<ApiResponse<Array<{
    id: string
    name: string
    code: string
    shortName?: string
  ...
  // 获取地区数据
  async getRegions(): Promise<ApiResponse<Array<{
    code: string
    name: string
    children?: Array<{
      code: string
